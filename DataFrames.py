...
''''FILTERING'''
#Filtering to confirm which total_bill is greater than 40 dollars
bool_series = tips['total_bill'] > 40

#Printing only the rows with total_bill higher than 40
print(tips[bool_series])

#To only show the Male customers
print(tips[tips['size'] > 3])

''''CONDITIONAL FILTERING'''
#AND & --- Both need to be True
#OR |(Plumb_line) --- Either one should be True
print(tips[(tips['total_bill'] > 30) & (tips['sex'] == 'Male')]) #Both are True
print(tips[(tips['total_bill'] > 30) | (tips['sex'] == 'Male')]) #One is True

#Getting all Orders made on the Weekend including Friday (Long Version)
